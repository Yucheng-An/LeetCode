...
TreeAPI.findNode(balanceTree1, 000).printTree()
print(TreeAPI.depthOfTree(balanceTree1))
print(TreeAPI.isBalanced(unbalanceTree1))
print(TreeAPI.isBalanced(balanceTree1))
